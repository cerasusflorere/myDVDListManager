...
<body>    
        ...
        <div class='add-block'>
            <div class='add-block-1'>
                ...
                <div class='add-area add-story-area'>
                    ...
                    <textarea id='add_story' class='add-story' placeholder="本当は？"></textarea>
                </div>
    ...
    <script>
        ...
        function getGroup() {
            ...
            console.log(option_groups_name);
            addOptionGroups();
        }
        ...
        function submitData() {
            ...
            let title_kana = document.getElementById('add_title_kana').value;
            console.log(title);
            console.log(title_kana);
            if(!title && !title_kana){
                return;
            }
            let duration_from = document.getElementById('add_duration_from').value;
            let duration_to = document.getElementById('add_duration_to').value;

            let locations = [];
            for(let i = 0; i < theater_number; i++){
                let location_prefecture = document.getElementById('add_location_prefecture_' + (i + 1)).value;
                if(!location_prefecture) {
                    theater_number = theater_number - 1;
                    return;
                }
                locations.push(Array(2));
                locations[i][0] = parseInt(location_prefecture, 10);
                locations[i][1] = document.getElementById('add_location_theater_' + (i + 1)).value;
            }
        ...
        function plusLocationForm() {
            if(location_number < 10) {
                ...
                new_locations_line.getElementsByClassName('add-location-theater')[0].id = 'add_location_theaterl_' + player_number;
